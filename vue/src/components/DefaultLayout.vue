      ...
      <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
         ...
         <DisclosurePanel class="md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
               <router-link v-for="item in navigation" :key="item.name" as="a" :to="item.to" active-class="bg-gray-900 text-white"
            ...
            <div class="pt-4 pb-3 border-t border-gray-700">
               ...
               <div class="mt-3 px-2 space-y-1">
                  <DisclosureButton as="a" @click="logout" class="cursor-pointer block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Sign out
                  </DisclosureButton>
               </div>
            </div>
         </DisclosurePanel>
