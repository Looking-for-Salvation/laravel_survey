      ...
      <form @submit.prevent="saveSurvey">
         <div class="shadow sm:rounded-md sm:overflow-hidden">
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
               <!-- Image -->
               <div>
                  <label class="block text-sm text-gray-700 font-medium" for="">Image</label>
               ...
               <div>
                  ...
                  <input v-model="model.title" type="text" name="title" id="title" autocomplete="survey_title"
               ...
               <div>
                  ...
                  <div class="mt-1">
                     <textarea name="description" id="description" cols="30" rows="3" v-model="model.description" autocomplete="survey_description"
               ...
               <div class="flex items-start">
                  <div class="flex items-center h-5">
                     <input type="checkbox" name="status" id="status" v-model="model.status"
                        class="h-4 w-4 focus:ring-indigo-500 border-gray-300 text-indigo-600 rounded">
                  </div>
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
               ...
               <div v-for="(question, index) in model.questions" class="">
                  <question-editor :question="question" :index="index" @change="questionChange" @addQuestion="addQuestion" @deleteQuestion="deleteQuestion">
                  </question-editor>
               </div>
            </div>
...
// Watch the current survey data change and when this happens we update the Local model
watch(
   () => store.state.currentSurvey.data,
   (newVal, oldVal) => {
      model.value = {
         ...JSON.parse(JSON.stringify(newVal)),
         status: newVal.state !== 'draft'
      };
   }
);
